package com.secondhandmarket.spring;
...
public class SecondHandMarketApplication {
	...
	@Bean 
	public CommandLineRunner initData2(UsuarioServicio usuarioServicio, ProductoServicio productoservicio) {
		return args ->{
			Usuario usuario = new Usuario("Luis Miguel", "López Magaña", null, "luismi.lopez@openwebinars.net", "Aa123456789");
