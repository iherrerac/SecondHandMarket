package com.secondhandmarket.spring.upload;
...
public class FileSystemStorageService implements StorageService{
     ...
     * del fichero a almacenar.Lo establecemos con la fecha del sistema mas el nombre proporcionado por el usuario.
     * Así evitaremos que se suban ficheros con el mismo nombre
     * 
     */
    @Override
